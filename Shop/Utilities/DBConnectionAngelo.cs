...
{
    public class DBConnectionAngelo
    {
        private static IConfiguration _config;

        public DBConnectionAngelo(IConfiguration config)
        {
            _config = config;
        }
        ...
        */
        ...
        public static bool RegisterUser(string constring, Usuario user, Contacto contact)
        {
        ...
        public static bool VerifyLogin(string connectionstring, Usuario user)
        {
        ...
        public static Cliente GetUserInformation(string connectionstring, string username)
        {
            connection(connectionstring);
        ...
        public static List<CarritoItem> GetUserShoppingCart(string connectionstring, int clientid)
        {
            connection(connectionstring);
        ...
        public static bool Order(string connectionstring, int idusuario, int iddireccion)
        {
            connection(connectionstring);
        ...
        public static List<Orden> GetUserOrders(string connectionstring, int idcliente)
        {
            connection(connectionstring);
        ...
        public static List<DetalleOrden> GetUserOrdersDetails(string connectionstring, int idorden)
        {
            connection(connectionstring);
