...
namespace Shop.Controllers
{
    public class LoginController : Controller
    {
        ...
        public JsonResult VerificarLogin(string nombreusuario, string password) {
            ...
            try
            {
                bool result = DBConnectionAngelo.VerifyLogin(connectionstr, user);
                
                if (result == true)
                {
                    Cliente cliente = DBConnectionAngelo.GetUserInformation(connectionstr, user.NombreUsuario);
                    ...
                    List<CarritoItem> cart = DBConnectionAngelo.GetUserShoppingCart(connectionstr, cliente.ClienteID);
