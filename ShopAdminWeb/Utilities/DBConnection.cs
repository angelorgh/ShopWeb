...
namespace ShopAdminWeb.Utilities
{
    public class DBConnection
    {
        ...
        public static List<EstadoProducto> GetAllEstadoProducto()
        {
            connection(connectionstring);
        ...
        public static bool UpdateProducto(int productoid, int marcaid, int categoriaid, int estadoid, string nombre, string descripcion, double precio) 
        {
            connection(connectionstring);
